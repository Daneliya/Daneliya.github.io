...
>
> Elasticsearch Java API Client 地址：https://www.elastic.co/guide/en/elasticsearch/client/java-api-client/8.8/getting-started-java.html
...
```java [HotelMapper.java]
/**
 * @author xxl
 * @date 2026/2/24 11:32
 */
@Mapper
...
elasticsearch:
  ...
  ssl:
    verification-mode: none # 关闭SSL验证（测试用）
```
...
ES 8.x（使用新的 Elasticsearch Java API Client）
